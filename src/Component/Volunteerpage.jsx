      ...
      <div className='Volunteerpage_image'>
        <div className='container text-center text-white'>
          <p className='hometext'>
            Join <span className='spncolor'>With Us...</span>
          </p>
        </div>
      </div>
      ...
      <div className='volunteercolor py-5'>
        <div className='container'>
          <div className='text-center'>
            <img
              src={require("../assets/image/logos/social army.jpg")}
              alt=""
            ...
            <div className='row justify-content-center m-0 p-0'>
              <div className='col-12 col-lg-9 col-md-11'>
                <div className='row'>
                  ...
                  <div className='col-12 col-sm-6'>
                    <label className='fw-medium fs-5'>Full Name:</label>
                    <input
                      type="text"
                      name='name'
                  ...
                  <div className='col-12 col-sm-6'>
                    ...
                    <input
                      ...
                      required
                    />
                    {/* <p id='emailerr' className='text-danger'></p> */}
                  </div>

                  <div className='col-12 col-sm-6'>
                    <label className='fw-medium fs-5'>Birth Date:</label>
                    <input
                      type="date"
                      name='date'
                      className='form-control'
                  ...
                  <div className='col-12'>
                    <label className='fw-medium fs-5'>Message:</label>
                    <textarea
                      name="textarea"
                      rows="5"
                      className='form-control'
                  ...
                  <div className='col-12 d-lg-flex d-block align-items-center mt-3'>
                    <label className='fw-medium fs-5 me-3'>Gender:</label>
                    <div className='form-check form-check-inline'>
                      <input
                        type="radio"
                        name='gender'
                  ...
                  <div className='col-12 mt-3'>
                    <label className='fw-medium fs-5'>Blood Group:</label>
                    <select
                  ...
                  <div className='col-12 mt-4'>
                    <button type="submit" className='volunteer p-2 fw-medium w-100 text-center fs-5 my-2'>Submit</button>
                  </div>
